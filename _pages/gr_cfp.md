...
- **Περιορισμός Μοναδικού ή Πρώτου Συγγραφέα**: Κάθε συμμετέχων δικαιούται να υποβάλει μόνο **μία περίληψη** ως μοναδικός συγγραφέας ή ως πρώτος συγγραφέας. Αυτός ο περιορισμός ισχύει για **τόσο τις συνεδρίες όσο και τις θεματικές συνεδρίες**.
- **Περιορισμός Συν-συγγραφής**:  Ένας συμμετέχων δύναται να υποβάλει **έως δύο περιλήψεις** ως συν-συγγραφέας. Αυτός ο περιορισμός ισχύει για **τόσο τις συνεδρίες όσο και τις θεματικές συνεδρίες**.
